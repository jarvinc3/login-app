        ...
        <main class="all-information-login">
            ...
            <form class="login-container" action="conexion.php" method="post">
                ...
                <div class="inputs">
                    ...
                    <input name="pswrd" type="text" placeholder="Password" required oninvalid="this.setCustomValidity('agregue una contraseñs')"  oninput="this.setCustomValidity('')">
                </div>
                <button class="btn" type="submit">Start coding now</button>
            </form>
            <section class="redes-sociales-container">
                <div>
                    <p class="text1">or continue these social profile</p>
                </div>
                <div class="redes-container">
                    <div class="redes-icon-container">
                ...
                <div class="login-option">
                    <p class="text2">Already a member?</p>
                    <a href="login.php"><p class="text3">Login</p></a>
