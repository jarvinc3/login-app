        ...
        <div class="container-principal">
            <nav class="nav">
                <div class="nav-container-superior">
                    ...
                    <div class="modal-nombre-foto">
                        ...
                        <form class="nav-bar close" id="navBar" action="close.php">
                           <p> <a href="profile.php"><span class="material-symbols-outlined profile">account_circle</span></a>My Profile</p>
                ...
                <div class="nav-containerInferior">
                    <a href="./profile.php">
                        <p class="back"><span class="material-symbols-outlined">arrow_back_ios </span> Back</p>
                    </a>
                </div>
            </nav>
            <main>
                ...
                <form action="editAction.php" enctype="multipart/form-data" method="post">
                    <section>
                            <div class="div-2">
                                ...
                                <label for='img' id='img'><span class='material-symbols-outlined'>photo_camera</span></label> 
                                <img class='foto-perfil-high' src='data:image/jpg;base64, $dataImg' alt='foto de perfil'>";} ?>
                    ...
                    <section>
                        <div class="div ">
                            <p class="p">BIO</p>
                            <input class="input" type="text" placeholder="Enter your biography" name="bio" value="<?php echo $_SESSION['bio'] ?>">
                        </div>
                    ...
                    <section>
                        <div class="div">
                            <p class="p">PHONE</p>
                            <input type="text" placeholder="Enter your phone number" name="phone" value="<?php echo $_SESSION['phone'] ?>">
                        </div>
                    ...
                    <section>
                        <div class="div">
                            <p class="p">EMAIL</p>
                            <input type="email" placeholder="Enter your email" value="<?php echo $_SESSION['email'] ?>" name="email">
                        </div>
                    ...
                    <section>
                        <div class="div">
                            ...
                            <input type="password" placeholder="Change your password" name="pswrd">
                        </div>
